...
export async function generateMetadata({ params }) {
  return createMetadata({
    title: "Transfer Bari-Ostuni - Servizio Navetta Diretto",
    description: "Servizio di Transfer diretto da Bari a Ostuni. Transfer da aeroporto e stazione di Bari verso Ostuni con autista privato.",
    path: "/transfer-bari-ostuni",
...
export default function SEOPage() {
    ...
    <main className="py-32 bg-black">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "Transfer Bari-Ostuni - Servizio Navetta Diretto",
          "description": "Servizio di Transfer diretto da Bari a Ostuni. Transfer da aeroporto e stazione di Bari verso Ostuni con autista privato.",
          "provider": {
            "@type": "LocalBusiness",
            "name": "Zaccaria NCC",
      ...
      <div className="container mx-auto px-6">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 chrome-text-enhanced">
          Transfer Bari-Ostuni - Servizio Navetta Diretto
        </h1>
        ...
        <div className="relative h-80 w-full mb-12 border border-dark-silver">
          <Image 
            ...
            alt="Transfer Bari-Ostuni - Servizio Navetta Diretto"
            fill
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent flex items-center">
            <div className="max-w-lg p-6">
              <p className="text-xl text-silver mb-6">
                Servizio di Transfer diretto da Bari a Ostuni. Transfer da aeroporto e stazione di Bari verso Ostuni con autista privato.
              </p>
              <Link 
                href="/#contact" 
  ...
  <h2 className="text-3xl font-bold mb-6">Transfer Premium per Ostuni</h2>
  <p className="text-lg mb-4">
    Zaccaria NCC offre un servizio di transfer esclusivo da e per Ostuni con vetture Mercedes di ultima generazione e autisti professionisti.
    Il nostro servizio transfer garantisce puntualità, comfort e un'esperienza di viaggio senza stress.
  </p>
  <p className="text-lg mb-4">
    Che siate in viaggio per affari o per piacere, il nostro servizio transfer rappresenta la soluzione ideale per raggiungere Ostuni
...
<section className="mb-12">
  <h2 className="text-3xl font-bold mb-6">Tipologie di Transfer per Ostuni</h2>
  <ul className="space-y-4">
    ...
    <li className="flex items-start">
      ...
      <div>
        ...
        <p className="text-silver">Servizio dedicato per matrimoni, concerti, meeting aziendali e altri eventi speciali a Ostuni.</p>
      </div>
    </li>
  </ul>
</section>
