...
export async function generateMetadata({ params }) {
  return createMetadata({
    title: "NCC Ostuni - Servizio con Autista Privato",
    description: "Servizio Premium di Noleggio Con Conducente a Ostuni. Transfer da/per aeroporti, tour guidati e servizio taxi con autisti professionisti.",
    path: "/ncc-ostuni",
...
export default function SEOPage() {
    ...
    <main className="py-32 bg-black">
      ...
      <script
        ...
        dangerouslySetInnerHTML={{ __html: JSON.stringify({
          "@context": "https://schema.org",
          "@type": "Service",
          "name": "NCC Ostuni - Servizio con Autista Privato",
          "description": "Servizio Premium di Noleggio Con Conducente a Ostuni. Transfer da/per aeroporti, tour guidati e servizio taxi con autisti professionisti.",
          "provider": {
            "@type": "LocalBusiness",
            "name": "Zaccaria NCC",
      ...
      <div className="container mx-auto px-6">
        <h1 className="text-4xl md:text-5xl font-bold mb-6 chrome-text-enhanced">
          NCC Ostuni - Servizio con Autista Privato
        </h1>
        ...
        <div className="relative h-80 w-full mb-12 border border-dark-silver">
          <Image 
            ...
            alt="NCC Ostuni - Servizio con Autista Privato"
            fill
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-black/70 to-transparent flex items-center">
            <div className="max-w-lg p-6">
              <p className="text-xl text-silver mb-6">
                Servizio Premium di Noleggio Con Conducente a Ostuni. Transfer da/per aeroporti, tour guidati e servizio taxi con autisti professionisti.
              </p>
              <Link 
                href="/#contact" 
  ...
  <h2 className="text-3xl font-bold mb-6">Servizio NCC a Ostuni di Alta Qualità</h2>
  <p className="text-lg mb-4">
    Zaccaria NCC offre un esclusivo servizio di noleggio con conducente a Ostuni con autisti professionisti e una flotta di veicoli Mercedes-Benz.
    Il nostro servizio NCC garantisce puntualità, comfort e un'esperienza di viaggio all'insegna dell'eleganza.
  </p>
  <p className="text-lg mb-4">
    Che si tratti di transfer aeroportuali, spostamenti di lavoro o tour turistici a Ostuni e dintorni, il nostro servizio di noleggio con conducente
    rappresenta la soluzione ideale per chi cerca un trasporto privato di alta qualità.
  </p>
</section>

<section className="mb-12">
  <h2 className="text-3xl font-bold mb-6">Perché Scegliere il Nostro Servizio NCC a Ostuni</h2>
  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
    ...
    <div className="metal-card">
      ...
      <p className="text-silver">
        I nostri autisti conoscono perfettamente Ostuni e la Puglia, parlano italiano e inglese,
    ...
    <div className="metal-card">
      ...
      <p className="text-silver">
        ...
        tutti i costi del servizio NCC a Ostuni.
      </p>
    </div>
  </div>
</section>
...
<section className="mb-12">
  <h2 className="text-3xl font-bold mb-6">Servizi NCC Disponibili a Ostuni</h2>
  <ul className="space-y-4">
    ...
    <li className="flex items-start">
      ...
      <div>
        ...
        <p className="text-silver">Escursioni personalizzate a Ostuni e nei dintorni con autista a vostra disposizione.</p>
      </div>
    </li>
    <li className="flex items-start">
      <div className="text-silver-metallic mr-4">
